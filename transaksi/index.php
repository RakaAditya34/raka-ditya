...
$sql = "SELECT * FROM peminjaman INNER JOIN anggota ON peminjaman.id_anggota=anggota.id_anggota INNER JOIN detail_pinjam dp USING(id_pinjam) 
...
<div class="card">
    ...
    <h2 class="card-title"><i class="fas fa-edit"></i>Data Peminjaman</h2>
        ...
        <div class="card-body">   
        <center>
        <a href="form-pinjam.php"><button type="button" class="btn btn-secondary">Tambah Data Peminjaman</button></a>
        </center>
        </br>
